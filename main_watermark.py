...
exp_name = args.cls1+'_'+args.cls2
...
SAVING_DIR = f"{Path(__file__).parent.parent}/PAMI_EXPDIR/"+exp_name
...
freeze=False
# OUTPUT_DIR = pjoin(SAVING_DIR, 'output')
# os.makedirs(OUTPUT_DIR)
# WEIGHTS_DIR = pjoin(OUTPUT_DIR, 'cifar10_resnet20_weights.97.hdf5')
