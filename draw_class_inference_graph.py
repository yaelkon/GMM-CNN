...
results_dir = pjoin(EXP_PATH, 'class_inferences')
...
for explaining_layer in reversed(layers_to_inference):
...
for head_class in head_classes:
    ...
    layers_clusters_dict['class'] = model.num_classes
